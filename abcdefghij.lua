...
KrnlGUI.Position = UDim2.new(0.122759856, 0, 0.223809525, 0)
KrnlGUI.Size = UDim2.new(0.613799274, 0, 0.545645297, 0)
...
InjectedMessgae.Size = UDim2.new(0.347566962, 0, 0.399907321, 0)
...
BlueLight.Size = UDim2.new(1, 0, 0.00299999979, 0)
...
GamesOpenGUI.Size = UDim2.new(0.347566962, 0, 0.399907321, 0)
...
TextLabel_6.Text = "禁用，因为大多数脚本都打了补丁。"
...
FloatingGUI.Position = UDim2.new(0.536738336, 0, 0.0984127, 0)
FloatingGUI.Size = UDim2.new(0.0349462368, 0, 0.0619047619, 0)
FloatingGUI.Image = "rbxassetid://11671355800"

-- Scripts:

local function MBSYV_fake_script() -- FileButton.LocalScript 
...
coroutine.wrap(MBSYV_fake_script)()
local function MPWC_fake_script() -- CreditsButton.LocalScript 
...
coroutine.wrap(MPWC_fake_script)()
local function NPONRXP_fake_script() -- GamesButton.LocalScript 
...
coroutine.wrap(NPONRXP_fake_script)()
local function QXKVOZ_fake_script() -- HotScriptsButton.LocalScript 
...
coroutine.wrap(QXKVOZ_fake_script)()
local function FSNZJIB_fake_script() -- OthersButton.LocalScript 
...
coroutine.wrap(FSNZJIB_fake_script)()
local function PSWJI_fake_script() -- Xbutton.LocalScript 
...
coroutine.wrap(PSWJI_fake_script)()
local function HXAI_fake_script() -- button.LocalScript 
...
coroutine.wrap(HXAI_fake_script)()
local function HQZW_fake_script() -- TextButton.LocalScript 
...
coroutine.wrap(HQZW_fake_script)()
local function LFZHJQ_fake_script() -- TextButton_2.LocalScript 
...
coroutine.wrap(LFZHJQ_fake_script)()
local function KMNY_fake_script() -- TextButton_3.LocalScript 
...
coroutine.wrap(KMNY_fake_script)()
local function QXSSPK_fake_script() -- TextButton_4.LocalScript 
...
coroutine.wrap(QXSSPK_fake_script)()
local function IURTC_fake_script() -- addbutton.LocalScript 
...
coroutine.wrap(IURTC_fake_script)()
local function FZBPZJ_fake_script() -- ImageLabel_2.LocalScript 
...
coroutine.wrap(FZBPZJ_fake_script)()
local function AXBMKVH_fake_script() -- ImageLabel_3.LocalScript 
...
coroutine.wrap(AXBMKVH_fake_script)()
local function FWOW_fake_script() -- Execute.LocalScript 
...
coroutine.wrap(FWOW_fake_script)()
local function DRCOGQL_fake_script() -- Clear.LocalScript 
	local script = Instance.new('LocalScript', Clear)

	local button = script.Parent
	local text = script.Parent.Parent.Parent.MainGUI.ExecuteBar.ScrollingFrame1.ImageLabel.EditorFrame.Source
	
	button.MouseButton1Click:Connect(function()
		text.Text = ""
	end)
end
coroutine.wrap(DRCOGQL_fake_script)()
local function MVRRKPW_fake_script() -- InjectButton.LocalScript 
...
coroutine.wrap(MVRRKPW_fake_script)()
local function QFDOE_fake_script() -- KrnlGUI.Drag 
...
coroutine.wrap(QFDOE_fake_script)()
local function MNJS_fake_script() -- Xbutton_2.LocalScript 
...
coroutine.wrap(MNJS_fake_script)()
local function LCHLOL_fake_script() -- Okbutton.LocalScript 
...
coroutine.wrap(LCHLOL_fake_script)()
local function CMLLIRL_fake_script() -- InjectedMessgae.Drag 
...
coroutine.wrap(CMLLIRL_fake_script)()
local function FSORB_fake_script() -- DexExplorer.LocalScript 
...
coroutine.wrap(FSORB_fake_script)()
local function HJEF_fake_script() -- OpenGui.LocalScript 
...
local function MINHHK_fake_script() -- RemoteSpy.LocalScript 
...
coroutine.wrap(MINHHK_fake_script)()
local function XVRN_fake_script() -- DarkDex.LocalScript 
...
coroutine.wrap(XVRN_fake_script)()
local function HMVBV_fake_script() -- UnamedEsp.LocalScript 
...
coroutine.wrap(HMVBV_fake_script)()
local function PUOZR_fake_script() -- IYFE.LocalScript 
...
coroutine.wrap(PUOZR_fake_script)()
local function LFLCU_fake_script() -- OwlHub.LocalScript 
...
coroutine.wrap(LFLCU_fake_script)()
local function IYLJLB_fake_script() -- HoHoHub.LocalScript 
...
coroutine.wrap(IYLJLB_fake_script)()
local function UFSFJ_fake_script() -- Xbutton_3.LocalScript 
...
coroutine.wrap(UFSFJ_fake_script)()
local function YGJKDDQ_fake_script() -- CreditsW.Drag 
...
coroutine.wrap(YGJKDDQ_fake_script)()
local function KMVT_fake_script() -- WHy.LocalScript 
...
coroutine.wrap(KMVT_fake_script)()
local function JFNZWT_fake_script() -- Nope.LocalScript 
...
coroutine.wrap(JFNZWT_fake_script)()
local function DCNQYHO_fake_script() -- KillTask.LocalScript 
...
coroutine.wrap(DCNQYHO_fake_script)()
local function SHKC_fake_script() -- Inject.LocalScript 
...
coroutine.wrap(SHKC_fake_script)()
local function CYHKY_fake_script() -- Xbutton_4.LocalScript 
...
coroutine.wrap(CYHKY_fake_script)()
local function RQTXAE_fake_script() -- Okbutton_2.LocalScript 
...
coroutine.wrap(RQTXAE_fake_script)()
local function YTTLBF_fake_script() -- GamesOpenGUI.Drag 
...
coroutine.wrap(YTTLBF_fake_script)()
local function RFWKI_fake_script() -- FloatingGUI.Drag 
...
coroutine.wrap(RFWKI_fake_script)()
local function YGWLJJ_fake_script() -- FloatingGUI.LocalScript 
	local script = Instance.new('LocalScript', FloatingGUI)
...
coroutine.wrap(YGWLJJ_fake_script)()
